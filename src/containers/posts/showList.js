...
class ShowList extends Component {
    ...
    render(){
        ...
        this.currentProviders = currentProviders && currentProviders.length > 0 && initReduceIdName(currentProviders) || []
        this.currentTypes = currentTypes && currentTypes.length > 0 && initReduceIdName(currentTypes, 'id',['slug', 'name']) || []

        console.log('=====5', this.currentTypes[1]);
